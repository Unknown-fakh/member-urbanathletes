      ...
      <div class="rounded-xl bg-gray-100 w-full mx-8 lg:w-4/6 shadow-xl overflow-hidden pb-6">
        <div class="p-4">
          ...
          <div class="grid grid-cols-3 items-center">
            <div>
              <a href="{{ url('/sixpack-challenge/daftar') }}" class="underline bg-yellow-400 rounded-md py-2 px-4"><i class="fa-solid fa-globe"></i> Kembali</a>
            </div>
            <div class="col-span-2">
              <form action="{{ route('sixpack-challenge.updateKode') }}" method="post">
                @csrf
                @method("put")
                <div class="flex">
