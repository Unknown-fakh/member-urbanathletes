        ...
        <div class="relative bg-white rounded-lg shadow mt-12">
          ...
          <div class="p-6 space-y-6 relative">
            <button type="button" id="btn-close-modal" data-modal-toggle="large-modal"
              class="text-white bg-red hover:text-gray-900 rounded-full text-sm p-2 ml-auto inline-flex items-center
            ...
            <ol class="list-decimal px-4">
              <li class="py-2">
                Membership 99k berlaku untuk mendapatkan fasilitas gym selama 14 hr berturut turut di salah satu cabang kami.
              </li>
              <li class="py-2">
                Fasilitas sama seperti regular membership yaitu semua kelas (kecuali kelas valor), latihan mandiri serta kolam renang untuk cabang Merr dan Tidar dan sauna untuk Lenmarc.
              </li>
              <li class="py-2">
                Harap diperhatikan * adalah  yang berhak mendapatkan promo ini adalah yang belum pernah join member atau trial di salah satu cabang dalam kurun waktu 6 bulan terakhir. Berusia minim 18 thn ke atas. 
              </li>
              <li class="py-2">
                Membership ini tidak mengikat setelah 14 hr habis. Berlaku untuk 1 x transaksi tidak dapat diulang.
              </li>
              <li class="py-2">
                Mohon pilih cabang dengan benar karena tidak dapat dipindah lokasi.
              </li>
              <li class="py-2">
                Non Refundable. Jadi mohon diperhatikan poin persyaratan tersebut diatas.  
              </li>                            
            </ol>
